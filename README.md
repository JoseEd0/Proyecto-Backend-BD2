...
Sistema de base de datos multimodal con parser SQL personalizado, estructuras de indexación avanzada (Sequential File, B+Tree, Hash, RTree) y API REST completa.
