...
class Heap:
    ...
    def __init__(
        ...
        if dir_path:  # Solo crear si hay un directorio en la ruta
    ...
    def _select_all(self, include_deleted: bool = False) -> List[List[Any]]:
        """
        Alias de scan_all() para compatibilidad con código legacy.
        Lee todos los registros del heap.

        Args:
            include_deleted: Parámetro ignorado (para compatibilidad),
                           esta implementación no usa flags de eliminación
